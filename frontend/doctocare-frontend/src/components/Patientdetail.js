...
export default function Patientdetail() {
  ...
  return (
//     <div className=" bg-blue-400 w-full h-[100%] px-4 py-8">
  ...
  <table className="min-w-full text-center shadow-lg">
    <thead className="bg-gray-800">
      <tr>
        ...
        <th className="px-1 py-3 text-lg font-semibold text-white">Name</th>
        <th className="px-4 py-3 text-lg font-semibold text-white">Age</th>
        <th className="px-4 py-3 text-lg font-semibold text-white">Patient-ID</th>
        <th className="px-4 py-3 text-lg font-semibold text-white">Doctor-ID</th>
        <th className="px-4 py-3 text-lg font-semibold text-white">Contact</th>
    ...
    <tbody className="bg-white">
      {docs.map((data, index) => (
        <tr key={index} className="border-b border-gray-200">
          <td className="px-4 py-3 text-sm text-gray-900">{index + 1}</td>
          <td className="px-1 py-3 text-sm text-gray-900"><FontAwesomeIcon className='text-5xl text-red-700 md:text-2xl mr-2' icon={faUserCircle} /></td>

          <td className="px-1 py-3 text-lg  mt-2 flex justify-center items-center font-
          semibold text-gray-900">{data.pname}</td>
